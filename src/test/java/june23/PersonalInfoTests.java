...
public class PersonalInfoTests {
	...
	public void navigateToHomePage() {
		System.out.println("Navigating to home page in @BeforeMethod.... ");
		driver.get(
		...
		github = "https://github.com/aybolek27";
	...
	public void submitFullApplication() {
		...
		Select education2 = new Select(driver.findElement(By.xpath("//select[@name='Dropdown']")));
		education2.selectByIndex(Integer.parseInt(education));

		driver.findElement(By.xpath("//input[@name='Website']")).sendKeys("https://github.com/aybolek27");
...
//					fail(rate + " is not a valid level");
	...
	public void setDateOfBirth(String bday) {
		...
		String birthday = pieces[0] + "-" + pieces[1] + "-" + pieces[5];
	...
	public void fullNameEmptyTest() {
		...
		// driver.findElement(By.xpath("//em[.=' Next ']")).click();
		// String
		// nameError=driver.findElement(By.xpath("//p[@id='error-Name']")).getText();
